...
public class WindowSurface extends EglSurfaceBase {
	 ...
	 * classes that expect to manage the Surface themselves (e.g. if you release
	 * a SurfaceView's Surface, the surfaceDestroyed() callback won't fire).
	 */
	...
	/**
	 * Releases any resources associated with the EGL surface (and, if
	 * configured to do so, with the Surface as well).
	 * <p>
