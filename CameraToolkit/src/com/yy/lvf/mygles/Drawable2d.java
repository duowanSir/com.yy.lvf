...
public class Drawable2d {
    ...
    private static final FloatBuffer TRIANGLE_BUF =
            GlesUtil.createFloatBuffer(TRIANGLE_COORDS);
    private static final FloatBuffer TRIANGLE_TEX_BUF =
            GlesUtil.createFloatBuffer(TRIANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer RECTANGLE_BUF =
            GlesUtil.createFloatBuffer(RECTANGLE_COORDS);
    private static final FloatBuffer RECTANGLE_TEX_BUF =
            GlesUtil.createFloatBuffer(RECTANGLE_TEX_COORDS);
    ...
    private static final FloatBuffer FULL_RECTANGLE_BUF =
            GlesUtil.createFloatBuffer(FULL_RECTANGLE_COORDS);
    private static final FloatBuffer FULL_RECTANGLE_TEX_BUF =
            GlesUtil.createFloatBuffer(FULL_RECTANGLE_TEX_COORDS);
