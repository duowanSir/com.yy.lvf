...
// * <p>
// * It uses MediaExtractor to get frames from a test stream, decodes them to a surface, uses a shader to edit them, encodes them
// * from the resulting surface, and then uses MediaMuxer to write them into a file.
// * <p>
// * It does not currently check whether the result file is correct, but makes sure that nothing fails along the way.
// * <p>
// * It also tests the way the codec config buffers need to be passed from the MediaCodec to the MediaMuxer.
// */
//@TargetApi(18)
//public class ExtractDecodeEditEncodeMuxTest23 extends AndroidTestCase {
//
//	private static final String TAG = ExtractDecodeEditEncodeMuxTest23.class.getSimpleName();
...
//		private ExtractDecodeEditEncodeMuxTest23 mTest;
//
//		private TestWrapper(ExtractDecodeEditEncodeMuxTest23 test) {
//			mTest = test;
//		}
//
//		@Override
...
//		}
//
//		public static void runTest(ExtractDecodeEditEncodeMuxTest23 test) throws Throwable {
...
//	 * <p>
//	 * We encode several frames of a video test pattern using MediaCodec, then decode the output with MediaCodec and do some
//	 * simple checks.
//	 */
//	@SuppressLint("NewApi")
...
//			Log.e(TAG, "unsupport outputVideoFormat " + outputVideoFormat);
//			return;
//		}
//		if (VERBOSE)
//			Log.d(TAG, "video found codec: " + videoEncoderName);
//
...
//		}
//		if (VERBOSE)
//			Log.d(TAG, "audio found codec: " + audioEncoderName);
//		// 以上都是定义输出格式，对兼容性的校验特别重要。
//
...
//						if (OUTPUT_AUDIO_AAC_PROFILE == MediaCodecInfo.CodecProfileLevel.AACObjectHE) {
...
//
//	/**
//	 * Creates an encoder for the given format using the specified codec, taking input from a surface.
//	 * <p>
